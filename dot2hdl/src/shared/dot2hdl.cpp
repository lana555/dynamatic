...
#include "../VHDL/eda_if.h"
#include "../VHDL/lsq_generator.h"
#include "../VHDL/reports.h"
#include "../VHDL/checks.h"
#include "../VHDL/sys_utils.h"

#include "../Verilog/GraphToVerilog.h"
...
//		filename = string(input_filename[indx]);
		...
		else
		{
		    ...
		    cout << "Generating " << output_filename[indx] << ".v" << endl;
