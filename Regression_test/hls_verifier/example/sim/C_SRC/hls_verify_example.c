...
void example( in_int_t x[100], in_int_t w[100], inout_int_t a[100])
{
	...
	hlsv_if_w = fopen("../INPUT_VECTORS/input_w.dat", "a");
	fprintf(hlsv_if_w, "[[transaction]] %d\n", hlsv_transaction_id);
	for(hlsv_i0 = 0; hlsv_i0 < 100; hlsv_i0++){
			fprintf(hlsv_if_w, "0x%08llx\n", (long long)w[hlsv_i0]);
		}
	fprintf(hlsv_if_w, "[[/transaction]]\n");
	fclose(hlsv_if_w);
...
int main(void){
      in_int_t feature[1][100];
      in_int_t weight[1][100];
      inout_int_t hist[1][100];
      in_int_t n[1];
